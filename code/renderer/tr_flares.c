...
*/
	...
	tess.vertexColors[tess.numVertexes].rgba[3] = f->drawIntensity * 255;      //----(SA)	mod for alpha blend rather than additive
//	tess.vertexColors[tess.numVertexes].rgba[3] = 255;		//----(SA)	mod for alpha blend rather than additive
	tess.numVertexes++;
